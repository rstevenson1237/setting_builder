...
- `GENRE.md` - this build's thematic spine (era, tone, magic level, structure). Fixed;
  edited directly by the user rather than generated by a step.
...
- `STEPS.md` - the authoritative, sequential build log.
