...
- **Low weight** - baseline only. State size, shape, purpose, one sound/smell, and exit type plainly, in the Referee Notes and Exits line. Nothing here should read as unusual or invite a second look - low-weight rooms are connective, not destinations.
