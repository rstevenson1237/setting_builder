...
Criteria are in `patterns/setting/Quests.md`; the registry is `setting/Quests.md`.
...
this region is unusual and needs a reason - a prisoner, a rival expedition, something that
bargains.

**Register supply, do not wait for demand.** When a location holds something a person
elsewhere would want - a substance, a relic, a body, a proof, a name - record it as a
Quest stub now, even if no giver exists yet. Givers are drafted from what has been
