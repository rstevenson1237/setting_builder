...
Criteria for what earns a `setting/Lore.md` row are in `patterns/setting/Lore.md`; this
file decides when to reach for one here.
...
At low and medium weight, lore **substitutes** for treasure: the location's find reads
better as something written than something worth coin. At high weight it sits
**alongside** the payload - a high-weight room can afford both the objective and the
document that explains or complicates it.
