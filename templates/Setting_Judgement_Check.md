...
- **Locations reinforce their region** - does each location's tags, dressing, Features, and Dangers actually reflect the parent Region Overview's Ambiance/Features/Dangers/Creatures, rather than reading as a location that could belong to any region?
